...
<body id="page-top" onload="initClock()">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="/#page-top"><img src="{{ asset('img/logo.png') }}" style=”float:left; width="55" ;height="55" ” />KLINIK {{ env('APP_NAME') }}</a>
            ...
            <table class="table table-flush" id="products-list">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> {{ $row->pasien->kodepasien }}</td>
                        <td> {{ $row->pasien->nama }}</td>
                        <td> {{ $row->jadwal_praktek }}</td>
                        <td> {{ $row->jadwal_antrian->format('d/m/Y') }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
